...
{
    public partial class appcursoContext : DbContext
    {
        public appcursoContext()
        {
        }

        public appcursoContext(DbContextOptions<appcursoContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Persona>(entity =>
            {
                ...
                entity.Property(e => e.Hermanos).HasMaxLength(50);
                ...
                entity.HasOne(d => d.IdTipoPersonaNavigation)
                    ...
                    .HasConstraintName("FK_Persona_PersonasTipo");
            });
